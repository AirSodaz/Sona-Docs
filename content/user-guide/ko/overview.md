...
- 완성본을 내보내거나 Storage Management, Cloud Sync (E2EE), Task Center, 진단 등의 설정 진입점을 찾는 경우: [내보내기와 설정](guide:export-and-settings)
...
6. [내보내기와 설정](guide:export-and-settings)에서 마무리하고, Sona가 작업 진행률, 복구, 업데이트, 자동화 결과를 표시할 때는 헤더의 Task Center 및 알림 센터를 확인합니다.
...
- 일상 사용에서 중요한 지원 화면: `Dashboard`, `Diagnostics`, `Storage Management`, `Cloud Sync`(E2EE), `Automation`, 작업 센터(Task Center)
