...
- If you later want standalone CLI file/live transcription, model management, transcript export, diagnostics, or the local API server, continue to the in-site [CLI Guide](guide:cli-guide).
