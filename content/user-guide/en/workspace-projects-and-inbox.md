...
- Sorting work across `All Items`, `Inbox`, and project scopes
- Applying project-specific defaults before you start new recordings or imports

## Understand the three scopes first
