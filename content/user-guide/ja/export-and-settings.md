...
- ヘッダーのメッセージセンターでは、一括文字起こし、自動化、LLM ジョブを一元管理し、リアルタイムの進捗確認、一括文字起こしのリアルタイムキャンセル、完了タスクのクリアメニューをサポートします。中断されたタスクはリカバリーセンターで再開または破棄できます。
