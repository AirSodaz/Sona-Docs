  ...
  return (
    ...
    >
      ...
      <g transform="translate(256, 256)" className="stroke-[#5c4d43] dark:stroke-[#E0E0E0] transition-colors" strokeWidth="48" strokeLinecap="round" strokeLinejoin="round" fill="none">
        ...
        */}
        <path d="M64 -144 
                 C16 -144 -64 -144 -64 -64 
                 C-64 16 64 -16 64 64 
                 C64 144 -16 144 -64 144" />
                 
        {/* Accent audio bar 1 (Left) */}
        <path d="M-128 -32 L-128 32" strokeWidth="32" opacity="0.6" />
        
        {/* Accent audio bar 2 (Right) */}
        <path d="M128 -32 L128 32" strokeWidth="32" opacity="0.6" />
      </g>
    </svg>
  );
}
